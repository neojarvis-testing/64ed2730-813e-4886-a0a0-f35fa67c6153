...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffaabbbbadadbdebcbacafff.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffaabbbbadadbdebcbacafff.ide.exam.ly');
